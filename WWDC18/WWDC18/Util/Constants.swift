...
private struct ImageName {
    ...
    public static let initialBackground = "Background - Initial"
    public static let sun = "Sun"
    public static let tree = "Tree"
    public static let treeWater = "Tree water"
    public static let appleTree = "Apple tree"
    public static let wateringCan = "Watering can"
    public static let wateringCanFilledOut = "Watering can filled out"
    ...
    public static let photosynthesisDrawing = "PhotosynthesisDrawing"
    
    public static let processLight = "Process - light"
    public static let processDark = "Process - dark"
    public static let kelvinCycle = "Kelvin Cycle"
    
    public static let cloud = "Cloud"
    public static let fishRight = "Fish2"
    public static let fishLeft = "Fish"
}
...
public struct Texture {
    ...
    //public static let foton = SKTexture(noiseWithSmoothness: 1, size: CGSize(width: Size.fotonRadius * 2, height: Size.fotonRadius * 2), grayscale: false)
...
public struct Action {
    public static let appear: SKAction = {
        ...
        let fase = SKAction.fadeIn(withDuration: 1)
        return SKAction.sequence([increaseScale, decreaseScale])
    }()
    public static var release: SKAction = {
        let xPosition: CGFloat = CGFloat((arc4random_uniform(4) * 10) + (arc4random_uniform(2)*2))
        let moveRight = SKAction.move(by: CGVector(dx: xPosition, dy: 40), duration: 0.5)
        let moveLeft = SKAction.move(by: CGVector(dx: -xPosition, dy: 70), duration: 0.5)
